                ...
                <div className="col-span-1 flex flex-col gap-4">
                    ...
                    <Card className="p-6 overflow-auto bg-appWhite h-[15rem] md:h-[15rem]">
                        <div className="flex flex-col gap-3">
                            {transactionsHistory ? transactionsHistory?.map((transaction, i) => (
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 gap-4`}>
                <div className="col-span-1 flex flex-col gap-4">
                    ...
                    <Card className="p-6 overflow-auto bg-appWhite h-[17rem] md:h-[17rem]" aria-labelledby="quick-transfer">
                        <div className="flex flex-col gap-5">
                            <CardSlider currentIndex={currentIndex} handlePrev={handlePrev} handleNext={handleNext} quickTransfer={quickTransfer}>
                                {quickTransfer ? quickTransfer?.map((user,i) => (
                                    <CardIcon i={i} key={i} currentIndex={currentIndex} {...user}/>
                                )): <CardIconLoader/>}
                            </CardSlider>
                ...
                <div className="col-span-1 md:col-span-2 flex flex-col gap-4">
                    ...
                    <Card className="p-6 overflow-auto bg-appWhite h-[17rem] md:h-[17rem]">
                        {lineChartData ? <LineChartGradient data={lineChartData} /> : <CardLoader/>}
                    </Card>
                </div>
            </div>
        </div>
